            ...
            <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                ...
                <div data-aos="fade-right" className="space-y-5">
                    ...
                    <p className="text-[#44002E] text-base leading-relaxed mb-5">
                       At SP Medifort Hospital, delivering world-class healthcare goes beyond clinical expertise. It includes a robust support system working silently behind the scenes. From digital infrastructure to sanitation, and from insurance coordination to engineering, our hospital facilities are meticulously designed to ensure safety, hygiene, comfort, and operational efficiency across every department.
                    ...
                    <p className="text-[#44002E] text-base leading-relaxed">
                      Our non-clinical departments serve as the backbone of hospital excellence, working 24*7 to create an environment where healing can truly thrive.
                        {/* <span className="font-bold">
                            seamless, efficient, and deeply supportive.
                        </span> */}
                    </p>
