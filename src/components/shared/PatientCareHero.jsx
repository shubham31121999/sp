            ...
            <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                ...
                <div data-aos="fade-right" className="space-y-14">
                    ...
                    <p className="text-[#44002E] text-base leading-relaxed">
                        At SP Medifort Hospital, we believe every patient deserves more than
                        treatment, they deserve an experience rooted in trust, transparency,
                        and care. From outpatient visits and admissions to insurance support
                        and global patient coordination, our patient care services are
                        designed to be{" "}
