const EndocrinologyData = {
  ...
  whyChoose: {
    ...
    subTitle: 'Expertise meets advanced technology',
    cards: [
      {
        icon: 'iconamoon:3d-bold',
        title: 'Board-certified endocrinologists with subspecialty training',

      },
      {
        icon: 'fluent:laser-tool-20-filled',
        title: 'Certified diabetes educators & dietitians on site',

      },
      {
        icon: 'mdi:heart-pulse',
        title: 'Continuous Glucose Monitoring (CGM) & insulin-pump clinic',

      },
      {
        icon: 'mdi:heart-cog-outline',
        title: 'GE Prodigy DEXA for bone-density analysis',

      },
      {
        icon: 'material-symbols:heart-check',
        title: 'Thyroid ultrasound & fine-needle aspiration unit',

      },
      {
        icon: 'streamline-plump:customer-support-7-remix',
        title: '24 × 7 ICU & emergency support for metabolic crises',
      },
    ],
    ...
    cta: {
      label: 'Explore our endocrine facilities',
  ...
  team: {
    ...
    subTitle: 'Your hormones are in skilled hands',
    doctors: [
      {
        name: 'DR. KARTHIK  V,',
    ...
    cta: {
      label: 'Meet our endocrinology team',
  ...
  faqs: [
    {
      question: 'Do you provide insulin-pump therapy for children?',
      answer: 'Yes, our pediatric endocrinologist supervises pump selection, training and follow-up.',
    },
    {
      question: 'Can thyroid nodules be evaluated in a single visit',
      answer: 'Most patients can complete ultrasound, lab tests and FNA biopsy on the same day.',
    },

  ],
  appointmentSection: {
    heading: "Consult an Endocrinologist",
    helpline: {
    ...
    form: {
      heading: "Schedule your hormone check-up",
...
export default EndocrinologyData;
