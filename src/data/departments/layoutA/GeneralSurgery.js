const GeneralSurgeryData = {
  ...
  whyChoose: {
    title: 'Why choose SP Medifort for general surgery?',
    subTitle: 'Where experience meets technology',
    cards: [
      {
        icon: 'iconamoon:3d-bold',
        title: '10+ highly experienced general surgeons',
      ...
      },
      {
        ...
        title: 'Modular OTs with laminar airflow',
    ...
    cta: {
      label: 'Explore surgical facilities',
      href: '/facilities#cardiac',
    }
  },
  team: {
    title: 'Our team of experts',
    subTitle: 'Your surgery is in safe hands',
    doctors: [
      {
  ...
  ctaSection: {
    text: "Our infrastructure allows for laparoscopic general surgery in Trivandrum that’s faster, safer, and leaves smaller scars.",
    button: {
      label: "Know our surgical tech",
      ...
      sections: [
        {
          ...
          items: [
            ...
            'Skin abscesses, boils, lumps',
            'Bleeding piles or anal fissures',
            'Lump under the skin or neck',
  ...
  patientJourney: {
    ...
    steps: [
      { title: "Outpatient consult & pre-op diagnosis" },
      { title: "Surgeon review and investigations" },
      { title: "Insurance clearance & fitness check" },
      { title: "Surgery & hospital stay" },
      { title: "Post-op follow-up, diet & dressing care" },
      { title: "Rehab or home-based recovery (if needed)" },
    ],
    cta: "Map your surgery plan",
  },
  successStories: {
    items: [
      {
  ...
  appointmentSection: {
    heading: "Get evaluated quickly, operate only if needed",
    helpline: {
      label: "Call:",
      number: "04713100100",
    ...
    form: {
      heading: "Surgery form",
      fields: ["Name", "Phone", "Email", "Query"],
      submitLabel: "Schedule surgical opinion"
    }
  }

};

export default GeneralSurgeryData;
