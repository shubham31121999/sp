...
const EntData = {
  ...
  whyChoose: {
    title: 'Why choose SP Medifort for ENT care?',
    subTitle: 'Precision, comfort & Multi-Specialty support',
    cards: [
      {
        icon: 'iconamoon:3d-bold',
        title: 'ENT Microsurgery & Nasal Endoscopy',

      },
      {
        icon: 'fluent:laser-tool-20-filled',
        title: 'Allergy & Sinus Clinic',
      ...
      },
      {
        ...
        title: 'ENT emergencies handled 24x7',

      },
      {
        icon: 'material-symbols:heart-check',
        title: 'Cochlear implant & hearing aid services',

      },
      {
        icon: 'streamline-plump:customer-support-7-remix',
        title: 'Pediatric& geriatric ENT care',
      },
    ],
    description: 'Our facilities, combined with top ENT specialists in Thiruvananthapuram, make us the preferred choice for complete ENT care.',
    cta: {
      label: 'Explore ENT facilities',
  ...
  team: {
    ...
    subTitle: 'Experienced Surgeons. Specialist Audiologists.',
    doctors: [
      {
    ...
    cta: {
      label: 'Meet our ENT specialists',
  ...
  ctaSection: {
    text: "Our ENT unit is backed by ICU, anesthesia, and surgical infrastructure, making us a top ENT care center in Trivandrum.",
    button: {
      label: "View ENT tech & labs",
      ...
      sections: [
        {
          ...
          items: [
            ...
            'Ear discharge, hearing loss, tinnitus',
            'Deviated nasal septum',
            'Chronic headache due to sinus issues',
  ...
  insuranceFinance: {
    ...
    cta: {
      label: "Check ENT insurance benefits",
  ...
  patientJourney: {
    ...
    steps: [
      ...
      { title: "Diagnosis + conservative/surgical plan" },
      { title: "Outpatient management or surgery scheduling" },
      { title: "Procedure (if required)" },
      { title: "Post-procedure review + therapy (speech/hearing)" },
    ],
    cta: "Know what to expect in ENT care",
  },
  successStories: {
    items: [
      {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'Most ENT surgeries are minimally invasive and performed under sedation or general anesthesia.',
    },

  ],
  appointmentSection: {
    heading: "ENT doctor appointment",
    helpline: {
      label: "ENT helpline:",
      number: "04713100100",
    ...
    form: {
      heading: "ENT query form",
      fields: ["Name", "Phone", "Email", "Query"],
      submitLabel: "Book ENT consultation"
    }
  }
