const FamilyMedicineData = {
  hero: {
    ...
    description: [
      "At SP Medifort, our Family Medicine department serves as your first and ongoing point of contact for lifelong healthcare. Whether it’s a child with a fever, a senior with diabetes, or a young adult needing vaccination — our family physicians manage prevention, diagnosis, and continuity of care.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            'Fatigue, dizziness, appetite loss',
            'High blood pressure, diabetes',
            'Joint pains, mild injuries, infections',
            'Preventive counseling for smoking, alcohol, diet',
            'Adolescent issues (depression, anxiety,  mental health concerns, eating disorder etc.)',
          ],
        },
        {
