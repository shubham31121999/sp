import React from 'react';
  ...
  whyChoose: {
    ...
    subTitle :'Where dentistry meets surgical precision',
    cards: [
      {
        icon: 'iconamoon:3d-bold',
        title: 'In-house maxillofacial surgeon and dental surgical team',
        
      },
      {
        icon: 'fluent:laser-tool-20-filled',
        title: ' Access to OT, ICU, anaesthesiology & emergency backup',
  ...
  team: {
  title: 'DR. KISHOR M A',
  subTitle: 'Maxillofacial surgeons. Dental specialists. Surgical support.',
  doctors: [
    {
  ...
  cta: {
    label: 'Meet our Dental & Maxillofacial team',
...
scopeOfCare: [
  ...
  cta: "Know what to expect from consultation to care",
},
  successStories: {
  items: [
...
appointmentSection: {
  ...
  helpline: {
    label: "Dental or oral surgery appointment:",
    number: "04713100100",
  ...
  export default DentalOralMaxillofacialSurgery;
