const NephrologyData = {
    ...
    cards: [
      {
        ...
        title: 'Advanced hemodialysis and peritoneal dialysis units',
      ...
      },
      {
        ...
        title: 'Pre- and post-transplant evaluation',

      },
      {
        icon: 'mdi:heart-cog-outline',
        title: 'Diabetic and hypertensive kidney care',

      },
      {
        icon: 'material-symbols:heart-check',
        title: 'Multidisciplinary team: cardiology, endocrinology, urology',
      },
      {
        icon: 'material-symbols:heart-check',
        title: 'Individualized nutrition & lifestyle planning for kidney health',
      },
    ],
    description: 'SP Medifort is one of the top nephrology hospitals in Trivandrum, known for safe dialysis care and high-risk kidney management.',
    cta: {
      label: 'Explore our Nephrology facilities',
      href: '/facilities#cardiac',
    }
  },
  team: {
    title: 'Our team of experts',
    subTitle: 'Nephrologists who care beyond numbers',
    doctors: [
      {
  ...
  ctaSection: {
    ...
    button: {
      label: "Explore Nephrology equipment",
  ...
  scopeOfCare: [
    {
      ...
      sections: [
        {
          title: 'Common Kidney conditions we treat',
          items: [
            'High creatinine levels',
            'Renal failure',
            'Protein in urine or blood in urine',
            'CKD stages 1 to 5',
            'Sudden kidney shutdown (AKI)',
            'Urinary tract infection-related kidney damage',
            'Refractory high blood pressure',
            'Edema (swelling of face/feet)',
  ...
  patientJourney: {
    ...
    steps: [
      ...
      { title: "Diagnosis of CKD/AKI or condition" },
      { title: "Lifestyle, diet, and medication plan" },
      { title: "Dialysis (if needed) or transplant referral" },
      { title: "Long-term monitoring and support" },
    ],
    cta: "Understand Kidney treatment flow",
  },
  successStories: {
    items: [
      {
    ...
    cta: {
      label: 'Read more Kidney recovery stories',
  ...
  faqs: [
    {
      question: 'How do I know if my kidneys are failing?',
      answer: 'Signs include swelling, reduced urine output, high BP, fatigue, and high creatinine levels. Only a doctor can confirm.',
    },
    {
      question: 'Is dialysis lifelong?',
      answer: 'Not always. Some recover, and others prepare for transplant. We aim to delay or avoid dialysis when possible.',
    },

  ],
  appointmentSection: {
    heading: "Kidney helpline",
    helpline: {
      label: "Call:",
      number: "04713100100",
    ...
    form: {
      heading: "Kidney Care contact form",
      fields: ["Name", "Phone", "Email", "Query"],
      submitLabel: "Schedule a Kidney checkup"
    }
  }

};

export default NephrologyData;
