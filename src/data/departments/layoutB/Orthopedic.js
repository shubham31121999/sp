const OrthopedicData = {
	...
	team: {
		...
		subTitle: 'Your recovery is led by the best',
		doctors: [
			{
		...
		cta: {
			label: 'Meet the full ortho team',
	...
	insuranceFinance: {
		...
		items: [
			{
				title: "Urology surgeries covered under all major plans",
				description: "Covered by all leading insurers and TPAs",
			},
			{
				title: "Cashless facility with Ayushman Bharat, TPA & CGHS",
				description:
					"Covered by all leading insurers and TPAs",
			},
			{
				title: "Laser & robotic procedures covered under specific urology riders",
				description:
					"Covered by all leading insurers and TPAs",
			},
			{
				title: "Finance support for infertility and advanced cancer care",
				description:
					"Covered by all leading insurers and TPAs",
			},
			{
		...
		cta: {
			label: "Verify your Urology coverage",
	...
	successStories: {
		...
		cta: {
			label: 'Read more Urology testimonials',
