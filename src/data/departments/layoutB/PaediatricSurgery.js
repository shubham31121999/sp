import React from 'react';
  ...
  whyChoose: {
    ...
    cards: [
      ...
      { icon: 'mdi:heart-pulse', title: ' Family-centered counseling and care' },
      { icon: 'mdi:heart-pulse', title: 'Round-the-clock pediatric emergency surgical coverage' },
      
    ],
    description: 'Our pediatric surgical unit ensures your child receives safe, expert, and emotionally sensitive care.',
    cta: {
  ...
  scopeOfCare: [
    {
      title: 'Pediatric Suregry Conditions We Treat',
     
      sections: [
        {
          title: 'Conditions & surgeries we handle',
          items: [
            'Birth Defect Clinic',
            'General Paediatric Surgery Clinic',
            'Paediatric Abdominal Surgery Clinic',
            'Paediatric Genitourinary Surgery Clinic',
            'Paediatric Plastic/Reconstructive Surgery Clinic',
            
          ],
        },
        {
          title: 'When to see a paediatric surgeon',
          items: [
            'Newborn with abdominal swelling or vomiting',
            'Umbilical or inguinal bulge',
            'Recurrent UTI or unusual urinary symptoms',
            'Birthmarks, lumps, or masses on child’s body',
            'Constipation or blood in stool in toddlers',
            'Child with difficulty in urination or testis not in place',
          ],
        },
      ],
    },
  ...
  insuranceFinance: {
    ...
    subtitle: "Surgical care for kids, fully covered",
    items: [
      { title: "All pediatric surgeries covered under family floater plans",  },
      { title: "NICU and neonatal surgeries under major schemes",  },
      { title: "Ayushman Bharat, RBSK & government plan acceptance", },
      { title: "Counseling on costs & consent procedures for families",  },
      { title: "Insurance Approval for Planned Surgeries",  },
      { title: "Insurance Support & Patient Counselling",  },
    ],
    cta: {
      label: "Check Child Surgery insurance options",
      link: "#",
    },
  },
  ...
  patientJourney: {
    ...
    steps: [
      { title: "Referral or initial consult with pediatric surgeon" },
      { title: "Child-friendly examination and imaging" },
      { title: "Admission or daycare planning" },
      { title: "Surgery with pediatric anesthesia" },
      { title: "PICU/NICU post-op care as needed" },
      { title: "Discharge with long-term support plan" },
    ],
    cta: "Understand the Pediatric Surgery process",
  },

  successStories: {
    items: [
      { type: 'text', text: '“Our newborn needed emergency surgery at 3 days old — the SP Medifort team saved her life.” — Megha R.' },
      { type: 'video', src: '/videos/Genesys-Vide-2.mp4', alt: 'Happy patient' },
      { type: 'text', text: '“They corrected my son’s hernia without stress. The doctor and nurses were so kind.” — Faisal M., Maldives' },
      { type: 'video', src: '/videos/Genesys-Vide-2.mp4', alt: 'Happy patient' },
    ],
    cta: {
  ...
  faqs: [
    {
      question: ' Will my child be under general anesthesia?',
      answer: 'Yes, but it’s given by experienced pediatric anesthetists using child-safe protocols.',
    },
    {
  ...
  appointmentSection: {
    ...
    form: {
      heading: "Book a surgical evaluation for your child",
