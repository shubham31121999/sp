  ...
  whyChoose: {
    title: 'Why choose SP Medifort for Surgical Oncology?',
    subTitle: 'Surgery that saves lives and preserves dignity',
    cards: [
      {
        icon: 'iconamoon:3d-bold',
        title: 'Cancer-specific surgical teams',

      },
      {
        icon: 'fluent:laser-tool-20-filled',
        title: ' Tumor board for collaborative decisions',

      },
      {
        icon: 'mdi:heart-pulse',
        title: 'Robotic and laparoscopic surgeries',
    ...
    cta: {
      label: 'Learn about Cancer surgery options',
  ...
  technologies: {
    ...
    items: [
      ...
      {
        name: 'KINEVO® 900 robotic microscope',
        description:
      ...
      {
        name: 'CT, MRI, USG, laparoscopy, thoracoscopy',
        description:
  ...
  ctaSection: {
    ...
    button: {
      label: "Explore our Surgical Oncology infrastructure",
  ...
  comprehensiveCare: {
    ...
    items: [
      ...
      {
        title: 'Breast conserving Surgery and Reconstruction',
      ...
      {
        title: 'GI Tumor Resections, Whipple Surgery',
        icon: 'mdi:heart-pulse',
        
      },
      {
        title: 'Radical Hysterectomy, Thyroidectomy',
        icon: 'mdi:heart-pulse',
        
      },
      {
        title: 'Esophagectomy, Gastrectomy, Lung Resection',
        icon: 'mdi:heart-pulse',
        
      },
      {
        title: 'HIPEC, RPLND, Colorectal Surgeries',
        icon: 'mdi:heart-pulse',
...
scopeOfCare: [
    ...
    sections: [
      {
        ...
        items: [
          "Head & neck cancers",
          "Breast, GI, urologic, gynecologic cancers",
          "Sarcomas, lung, skin tumors",
  ...
  insuranceFinance: {
    title: "Affordable care for a difficult journey",
    
    items: [
      {
        title: "Covered under most health and cancer insurance plans",
       
      },
      {
        title: "Cost-effective robotic/laparoscopic packages",
        
      },
      {
        title: "Pre-approval assistance for surgery coverage",
    ...
    cta: {
      label: "Check coverage for your Cancer Surgery",
  ...
  patientJourney: {
    ...
    cta: "Understand the Surgical Cancer pathway",
  },
  successStories: {
    items: [
      {
  ...
  faqs: [
    {
      question: 'Is cancer surgery safe?',
      answer: 'Yes, especially in early stages with experienced surgeons.',
    },
    {
      question: 'Will I need chemo or radiation too?',
      answer: 'It depends on the stage. Many benefit from combination therapy.',
    },
  ...
  appointmentSection: {
    ...
    form: {
      heading: "Get a Surgical opinion for your cancer",
