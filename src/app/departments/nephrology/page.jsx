...
import NephrologyData from '@/data/departments/layoutA/Nephrology';
...
function Page(hero, whyChoose, team,technologies, ctaSection ,highlightText ,comprehensiveCare , scopeOfCare ,insuranceFinance ,patientJourney, successStories, faqs, appointmentSection) {
  return (
    <div>
      <HeroA hero={NephrologyData.hero} />
      <TextSlider highlightText={NephrologyData.highlightText} />
      <WhyChooseA whyChoose={NephrologyData.whyChoose} />
      <OurTeamA team={NephrologyData.team} />
      <TechnologiesSectionA data={NephrologyData.technologies} />
      <Cta ctaSection={NephrologyData.ctaSection} />
      <TextSlider highlightText={NephrologyData.highlightText} />
      <ComprehensiveServices comprehensiveCare={NephrologyData.comprehensiveCare} />
      <CommonConditions scopeOfCare={ NephrologyData.scopeOfCare } />
      <InsuranceAndFinance insuranceFinance={ NephrologyData.insuranceFinance}/>
      <PatientJourney patientJourney={NephrologyData.patientJourney} />
      <SuccessStories successStories={NephrologyData.successStories} />
      <Faq faqs={NephrologyData.faqs} />
      <AppointmentConsultation appointmentSection={NephrologyData.appointmentSection} />
    </div>
  );
}
