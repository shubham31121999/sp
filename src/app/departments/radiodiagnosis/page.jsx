...
import radiodiagnosisData from '@/data/departments/layoutB/radiodiagnosisData';
...
function Page(hero, whyChoose, team,technologies, ctaSection ,highlightText ,comprehensiveCare , scopeOfCare ,insuranceFinance ,patientJourney, successStories, faqs, appointmentSection) {
  return (
    <div>
      <HeroA hero={radiodiagnosisData.hero} />
      <TextSlider highlightText={radiodiagnosisData.highlightText} />
      <WhyChooseA whyChoose={radiodiagnosisData.whyChoose} />
      <OurTeamA team={radiodiagnosisData.team} />
      <TechnologiesSectionA data={radiodiagnosisData.technologies} />
      <Cta ctaSection={radiodiagnosisData.ctaSection} />
      <TextSlider highlightText={radiodiagnosisData.highlightText} />
      <ComprehensiveServices comprehensiveCare={radiodiagnosisData.comprehensiveCare} />
      <CommonConditions scopeOfCare={ radiodiagnosisData.scopeOfCare } />
      <InsuranceAndFinance insuranceFinance={ radiodiagnosisData.insuranceFinance}/>
      <PatientJourney patientJourney={radiodiagnosisData.patientJourney} />
      <SuccessStories successStories={radiodiagnosisData.successStories} />
      <Faq faqs={radiodiagnosisData.faqs} />
      <AppointmentConsultation appointmentSection={radiodiagnosisData.appointmentSection} />
    </div>
  );
}
