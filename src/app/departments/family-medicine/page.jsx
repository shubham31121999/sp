...
import FamilyMedicineData from '@/data/departments/layoutA/FamilyMedicine';
...
function Page(hero, whyChoose, team,technologies, ctaSection ,highlightText ,comprehensiveCare , scopeOfCare ,insuranceFinance ,patientJourney, successStories, faqs, appointmentSection) {
  return (
    <div>
      <HeroA hero={FamilyMedicineData.hero} />
      <TextSlider highlightText={FamilyMedicineData.highlightText} />
      <WhyChooseA whyChoose={FamilyMedicineData.whyChoose} />
      <OurTeamA team={FamilyMedicineData.team} />
      <TechnologiesSectionA data={FamilyMedicineData.technologies} />
      <Cta ctaSection={FamilyMedicineData.ctaSection} />
      <TextSlider highlightText={FamilyMedicineData.highlightText} />
      <ComprehensiveServices comprehensiveCare={FamilyMedicineData.comprehensiveCare} />
      <CommonConditions scopeOfCare={ FamilyMedicineData.scopeOfCare } />
      <InsuranceAndFinance insuranceFinance={ FamilyMedicineData.insuranceFinance}/>
      <PatientJourney patientJourney={FamilyMedicineData.patientJourney} />
      <SuccessStories successStories={FamilyMedicineData.successStories} />
      <Faq faqs={FamilyMedicineData.faqs} />
      <AppointmentConsultation appointmentSection={FamilyMedicineData.appointmentSection} />
    </div>
  );
}
