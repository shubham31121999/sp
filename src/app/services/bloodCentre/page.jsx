...
const techImg1 =
  "/images/Services/bloodCentre/Advanced-Cold-Chain-&-Refrigeration-Systems.webp";
const techImg2 =
  "/images/Services/bloodCentre/Automated-Blood-Grouping-&-Cross-Match-Equipment.webp";
const techImg3 =
  "/images/Services/bloodCentre/Component-Separator-&-Blood-Bag-Sterile-Processing.webp";
const techImg4 =
  "/images/Services/bloodCentre/Digital-Donor-Database-and-Screening-Tools.webp";
const techImg5 =
  "/images/Services/bloodCentre/Emergency-Storage-with-Rapid-Access-Protocols.webp";
const techImg6 =
  "/images/Services/bloodCentre/NABH-&-Government-licensed-Blood-Bank-Facility.webp";
...
const data = {
  hero: {
    ...
    tagline:
      "Life Flows Through Us — Trusted, Tested, and Always Ready to Save Lives.",
  },
  overview: {
    heading: "Overview",
    description: [
      "The Blood Centre at SP Medifort Hospital plays a vital role in emergency and surgical care by ensuring the availability of safe, screened, and readily accessible blood and blood products 24*7. With a dedicated and NABH-compliant setup, our centre supports everything from life-saving transfusions to planned surgeries and cancer treatments.",
      "As a leading blood bank in Trivandrum, we uphold the highest standards in blood collection, testing, storage, and distribution.",
    ],
  },
  whatWeOffer: [
    ...
    "Blood Storage & Emergency Delivery",
    "Leukoreduced Blood Products for Oncology & Transplants",
    "Apheresis Services (on request)",
  ],
  team: [
    "Licensed Blood Bank Medical Officers",
    "Certified Blood Transfusion Technicians",
    "Pathologists & Haematologists (for complex compatibility cases)",
    "Trained Blood Transfusion Technicians & Nursing Staff for transfusion monitoring",
    "Blood Donor Counsellors ensuring donor safety & education",
  ],
  technologies: [
    "NABH & Government-licensed Blood Bank Facility",
    "Advanced Cold Chain & Refrigeration Systems",
    "Automated Blood Grouping & Cross-Match Equipment",
    "Component Separator & Blood Bag Sterile Processing",
    "Digital Donor Database and Screening Tools",
    "Emergency Storage with Rapid Access Protocols",
  ],
  whenToUse: [
    "During surgical procedures requiring transfusion",
    "For accidents, trauma, or emergency blood loss",
    "As part of chemotherapy, transplant, or dialysis protocols",
    "For anaemia or bleeding disorders",
    "During maternity/postpartum haemorrhage cases",
    "For voluntary donation drives or blood component requests",
    "For managing chronic conditions like thalassemia or sickle cell disease",
    "During treatment of severe infections causing low blood counts (e.g., dengue, sepsis)",
  ],
  whyChoose: [
    "Available 24x7 for emergency support",
    "100% screened & safe blood",
    "Component-wise availability (platelets, PRBC, FFP)",
    "In-house cross-match & compatibility support",
    "Voluntary & replacement donor facility",
    "Supports blood needs for surgeries, oncology, dialysis, and maternity care",
  ],
  successStories: [
    {
      content:
        "We needed platelets urgently at midnight for my brother. The SP Medifort 24x7 blood centre in Trivandrum responded within minutes — they saved a life.",
      author: "Anil S.",
    },
    {
      content:
        "I regularly donate here because of how professionally they manage the process. Clean, quick, and kind.",
      author: "Meera T.",
    },
  ],
  faqs: [
    {
      question: "Is the blood at SP Medifort screened for infections?",
      answer:
        "Yes. All blood is rigorously screened for HIV, Hepatitis B & C, Syphilis, and Malaria before release.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Only processing and testing charges apply as per medical regulations. We do not charge for donated units.",
    },
    {
      question: "Can someone donate blood for a specific patient?",
      answer:
        "Yes. Replacement donations can be made after medical clearance by our blood centre team.",
    },
  ],
  appointmentSection: {
          ...
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              <h2 className="text-[32px] sm:text-[40px] md:text-[48px] font-bold tracking-[-0.4px] text-[#41002d] mb-8">
                Why Choose SP Medifort <br /> Blood Centre
              </h2>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden w-full max-w-[427px] mx-auto">
                <img
                  src="/images/Services/bloodCentre/Blood-Centre(why choose).webp"
