...
const techImg1 =
  "/images/Services/pharmacy/Digital-inventory-and-barcode-based-dispensing.webp";
const techImg2 =
  "/images/Services/pharmacy/Prescription-validation-system-integrated-with-EMR.webp";
const techImg3 =
  "/images/Services/pharmacy/Separate-storage-for-temperature-sensitive-drugs.webp";
const techImg4 =
  "/images/Services/pharmacy/Controlled-medication-lockers-for-restricted-drugs.webp";
const techImg5 =
  "/images/Services/pharmacy/Auto-reminder-system-for-refills-(IPD-&-long-term-care).webp";
const techImg6 =
  "/images/Services/pharmacy/NABH-compliant-storage,-labelling-&-tracking.webp";
...
const data = {
  hero: {
    ...
    tagline:
      "Reliability in Every Dose — Safe, Timely, and 24*7 Access to Essential Medicines.", // updated tagline
  },
  overview: {
    heading: "Overview",
    description:
      "The Pharmacy Department at SP Medifort Hospital is a round-the-clock facility that ensures safe, accurate, and timely dispensing of prescribed medications. Our in-house pharmacy plays a critical role in patient care, supporting doctors and nurses with verified, high-quality medicines, including life-saving drugs, oncology treatments, and post-operative support.\nWe are recognized as a trusted hospital pharmacy in Trivandrum, adhering to NABH protocols and supervised by licensed pharmacists at every shift.", // updated overview
  },
  whatWeOffer: [
    "24*7 pharmacy service for inpatients & emergencies",
    "Prescription-based outpatient pharmacy",
    "ICU, OT, and Emergency Medicine Coordination",
    "High-alert drug management (e.g., insulin, anticoagulants)",
    "Cold storage medications (insulin, vaccines, biologics)",
    "Oncology & Chemotherapy Drug Dispensing",
    "Paediatric & Neonatal dose-specific formulations",
    "Consumables & surgical supplies for IPD/OT",
    "Drug stock monitoring and expiry control",
  ],
  team: [
    "Licensed Pharmacists trained in hospital protocols",
    "Pharmacy Assistants for logistics and counter support",
    "Pharmacology Supervisors for drug interaction and verification",
    "Inventory Coordinators ensuring uninterrupted stock",
  ],
  technologies: [
    "Digital inventory and barcode-based dispensing",
    "Prescription validation system integrated with EMR",
    "Separate storage for temperature-sensitive drugs",
    "Controlled medication lockers for restricted drugs",
    "Auto-reminder system for refills (IPD & long-term care)",
    "NABH-compliant storage, labelling & tracking",
  ],
  whenToUse: [
    "During your hospital stay (inpatient care)",
    "For emergency medications during off-hours",
    "While visiting the OPD with a prescription",
    "After surgery, for post-operative care medications",
    "When prescribed specialized drugs (oncology, transplant, high-risk)",
    "For children, the elderly, or home-care medication refills",
    "To access pharmacist counselling on dosage and drug interactions",
    "When requiring 24*7 access to a fully stocked hospital pharmacy",
  ],
  whyChoose: [
    "24*7 operations with emergency access",
    "Only quality-approved, prescription-verified medicines",
    "Drug availability across all categories (general to specialty)",
    "Zero substitution policy without doctor approval",
    "Close integration with ICU, OT & Oncology care",
    "Friendly, multilingual staff for patient support",
  ],
  successStories: [
    {
      content:
        "Even during a medical emergency at 3 AM, the pharmacy was ready. Everything was smooth and professional.",
      author: "Vishnu K.",
    },
    {
      content:
        "They explained every medicine clearly and ensured there were no duplicates. One of the best medical pharmacies in Trivandrum.",
      author: "Fatima B.",
    },
  ],
  faqs: [
    {
      question: "Is the pharmacy open all night?",
      answer:
        "Yes, the pharmacy is fully operational 24*7 for both inpatients and emergencies.",
    },
    {
      question: "Can I buy medicines without a prescription?",
      answer:
        "Only OTC (over-the-counter) items can be sold without a prescription. All prescription drugs need a valid doctor's note.",
    },
    {
      question: "Do you store refrigerated medications?",
      answer:
        "Yes. Vaccines, insulin, and other cold-chain drugs are stored in temperature-controlled units.",
    },
    {
      question: "Can I buy chemotherapy or specialized medication here?",
      answer:
        "Yes, but only upon consultant approval. We follow strict documentation and verification protocols for high-alert medications.",
    },
  ],
  appointmentSection: {
    heading: "Need Medicines? We’re Always Open.",
    description:
      "Visit SP Medifort – Your trusted in-house hospital pharmacy in Trivandrum",
    callToAction: "Call Us: +91-XXXXXXXXXX",
    buttons: ["Locate Pharmacy", "WhatsApp Now"],
  },
};
    ...
    <div className="min-h-screen bg-gray-100 font-sans text-gray-900">
      ...
      <section className="relative w-full bg-[#EFDAD9] overflow-hidden">
        ...
        <div className="relative w-full max-w-[1800px] mx-auto px-4 md:px-8">
          <div className="overflow-hidden rounded-t-2xl">
            <img
              src="/images/Services/banner-img/Pharmacy.webp"
              alt="Blood Vials"
          ...
          <div className="w-full max-w-[1800px] mx-auto flex flex-col md:flex-row items-start gap-4 md:gap-6 lg:gap-8">
            ...
            <div className="flex-1 flex justify-center md:justify-end w-full">
              <div className="w-[280px] sm:w-[400px] md:w-[520px] h-[210px] sm:h-[320px] md:h-[391px] rounded-2xl overflow-hidden shadow-xl border-[3px] border-[#ecd7ee]">
                <img
                  src="/images/Services/overview-img/Pharmacy.webp"
          ...
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              <h2 className="text-[32px] sm:text-[40px] md:text-[48px] font-bold tracking-[-0.4px] text-[#41002d] mb-8">
                Why Choose SP Medifort Pharmacy?
              </h2>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden w-full max-w-[427px] mx-auto">
                <img
                  src="/images/Services/pharmacy/Pharmacy(why-choose).webp"
      ...
      {data.appointmentSection && (
        <section className="relative w-full min-h-[350px] flex items-center overflow-hidden px-4 md:px-16 py-14 md:py-28">
          <img
            src="/images/Services/pharmacy/Pharmacy(footer).webp"
            alt=""
