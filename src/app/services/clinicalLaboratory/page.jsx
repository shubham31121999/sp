...
const data = {
  hero: {
    ...
    tagline:
      "Precision That Saves Lives — Trusted Diagnostics, Delivered On Time.",
  },
  overview: {
    heading: "Overview",
    description:
      "The Clinical Laboratory at SP Medifort Hospital is a state-of-the-art diagnostic facility offering a full range of routine and specialized investigations with speed, accuracy, and reliability. Our laboratory operates 24*7 and is staffed by experienced pathologists and technicians trained in international best practices. As a NABL-accredited diagnostic lab in Trivandrum, we ensure each sample is handled with care, reported with precision, and contributes meaningfully to patient diagnosis and treatment planning.", // ✅ Replaced entire overview with Word doc version
  },
  whatWeOffer: [
  ...
  whenToUse: [
    ...
    "Hormonal and thyroid evaluations for endocrine disorders",
    "Cancer marker tests or genetic screenings, when indicated",
  ],
  whyChoose: [
  ...
  successStories: [
    {
      content:
        "They collected my blood sample at 6 AM and sent my report by 9 AM. Quick, clean, and professional. Best blood test lab in Trivandrum.", // ✅ Replaced testimonials
      author: "Arjun M.",
    },
    {
      content:
        "We rely on SP Medifort’s lab for all our family tests, especially during emergencies. The staff is responsive and kind.",
      author: "Nalini S.",
    },
  ],
  faqs: [
    {
      ...
      answer:
        "Yes. The Clinical Laboratory is open 24*7, including Sundays and public holidays.",
    },
    {
      question: "Can I get my reports online?",
      answer:
        "Absolutely. Reports are shared via email, patient portal, or WhatsApp as per your preference.",
    },
    {
      question: "Do I need a prescription for blood tests?",
      answer:
        "For most tests, yes. However, general health check-ups and wellness panels can be taken without one.",
    },
    {
      question: "Do you offer a home sample collection?",
      answer:
        "Yes, on request. Please call to schedule a home visit for eligible patients.",
    },
  ],
  appointmentSection: {
    heading: "Book a Test or Visit Our Lab Today",
    description:
      "Visit SP Medifort – Your trusted clinical laboratory in Trivandrum",
      ...
      <section className="relative w-full bg-[#EFDAD9] overflow-hidden">
        ...
        <div className="relative w-full max-w-[1800px] mx-auto px-4 md:px-8">
          <div className="overflow-hidden rounded-t-2xl">
            <img
              src="/images/Services/banner-img/Clinical-Laboratory.webp"
              alt="Blood Vials"
          ...
          <div className="w-full max-w-[1800px] mx-auto flex flex-col md:flex-row items-start gap-4 md:gap-6 lg:gap-8">
            ...
            <div className="flex-1 flex justify-center md:justify-end w-full">
              <div className="w-[280px] sm:w-[400px] md:w-[520px] h-[210px] sm:h-[320px] md:h-[391px] rounded-2xl overflow-hidden shadow-xl border-[3px] border-[#ecd7ee]">
                <img
                  src="/images/Services/overview-img/Clinical-Laboratory.webp"
          ...
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              <h2 className="text-[32px] sm:text-[40px] md:text-[48px] font-bold tracking-[-0.4px] text-[#41002d] mb-8">
                Why Choose SP Medifort Clinical Laboratory?
              </h2>
